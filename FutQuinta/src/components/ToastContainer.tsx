      ...
      <AnimatePresence>
        {toasts.map(toast => (
          <motion.div
            ...
            className="flex items-stretch rounded-lg shadow-xl overflow-hidden pointer-events-auto border"
            style={{ backgroundColor: 'rgba(35,41,56,0.95)', borderColor: 'var(--color-surface-border)', backdropFilter: 'blur(12px)' }}
          >
            <div className={`w-1.5 shrink-0 ${accentBg[toast.type]}`} />
